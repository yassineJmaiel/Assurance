        ...
        <div class="col-xl-12 col-md-12">
            <div class="ms-panel">
                <div class="ms-panel-header ms-panel-custome">
                    <h6>ajouter Membre Famille</h6>
                </div>
                <div class="ms-panel-body">
                    <form class="needs-validation" method="post" action="/ajout_membre">
                        @csrf
                        <input type="hidden" name="assurer_id" value="{{Auth::user()->id}}">
                        <input type="hidden" name="assureur_id" value="{{$infos->assureur_id}}">
